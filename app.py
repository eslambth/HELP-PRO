...
try:
    ...
    # تم التعديل بناءً على نتائج الفحص الناجحة في الصورة الأخيرة
...
with st.sidebar:
    ...
    st.markdown("<p style='text-align: center; color: #8b949e;'>Proje Mimarı v2.5</p>", unsafe_allow_html=True)
    st.divider()
